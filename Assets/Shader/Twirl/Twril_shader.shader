...
Shader "Portal_shader"
{
	Properties
	{
		...
		[ASEBegin]_rotateScale("rotateScale", Float) = 5
		_rotateSpeed("rotateSpeed", Range( 0 , 1)) = 1
		[HDR]_Color0("Color 0", Color) = (0,0.09997082,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord47_g1 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 temp_cast_0 = (( _TimeParameters.x * _rotateSpeed )).xx;
				...
				float2 coords6 = appendResult44_g1 * _rotateScale;
				float2 id6 = 0;
				float2 uv6 = 0;
				float fade6 = 0.5;
				float voroi6 = 0;
				...
				voroi6 += fade6 * voronoi6( coords6, time6, id6, uv6, 0,voronoiSmoothId0 );
				rest6 += fade6;
				coords6 *= 2;
				fade6 *= 0.5;
				}//Voronoi6
				...
				float4 Color = ( tex2D( _Texture, ( IN.texCoord0.xy + voroi6 ) ) * _Color0 );
				float Mask = 1;
...
/*ASEBEGIN
Version=18912
38;244.6667;969.3334;885;1082.92;1042.438;2.383382;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-1055.154,224.5756;Inherit;False;Property;_rotateSpeed;rotateSpeed;1;0;Create;True;0;0;0;False;0;False;1;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;9;-1058.154,97.57565;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-924.3297,-25.14861;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-871.1539,144.5756;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;4;-938.3297,-176.1487;Inherit;False;Constant;_Vector1;Vector 1;0;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;8;-571.3299,-18.14859;Inherit;False;Property;_rotateScale;rotateScale;0;0;Create;True;0;0;0;False;0;False;5;8.48;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;3;-699.3299,-341.1487;Inherit;True;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-571.3299,-120.1486;Inherit;False;Constant;_rotateAngle;rotateAngle;0;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;6;-204.443,-296.0415;Inherit;True;2;1;1;2;8;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;2;False;2;FLOAT;5;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.TexCoordVertexDataNode;16;-206.4254,-546.7397;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;17;108.3917,-412.9909;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;13;353.4301,-207.5794;Inherit;False;Property;_Color0;Color 0;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0.09997082,1,0;0.5373883,13.50008,21.36125,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;416.7319,-569.3253;Inherit;True;Property;_Texture;Texture;3;0;Create;True;0;0;0;False;0;False;-1;a8ba3857b153b8848b843af17242f878;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;659.6258,-217.1172;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=24154181082EAB198DBEA272AA723081890B484A